...
use AcVendor\DI\Definition\FactoryDefinition;
use AcVendor\DI\Definition\Helper\DefinitionHelper;
use AcVendor\DI\Definition\InstanceDefinition;
use AcVendor\DI\Definition\ObjectDefinition;
use AcVendor\DI\Definition\Resolver\DefinitionResolver;
use AcVendor\DI\Definition\Resolver\ResolverDispatcher;
use AcVendor\DI\Definition\Source\CachedDefinitionSource;
use AcVendor\DI\Definition\Source\DefinitionSource;
use AcVendor\DI\Definition\Source\MutableDefinitionSource;
use AcVendor\DI\Invoker\DefinitionParameterResolver;
use AcVendor\DI\Proxy\ProxyFactory;
use Exception;
use AcVendor\Interop\Container\ContainerInterface as InteropContainerInterface;
use InvalidArgumentException;
use AcVendor\Invoker\Invoker;
use AcVendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use AcVendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use AcVendor\Invoker\ParameterResolver\DefaultValueResolver;
use AcVendor\Invoker\ParameterResolver\NumericArrayResolver;
use AcVendor\Invoker\ParameterResolver\ResolverChain;
 ...
 */
class Container implements ContainerInterface, InteropContainerInterface, FactoryInterface, \AcVendor\DI\InvokerInterface
{
    /**
    ...
    /**
     * @var \AcVendor\Invoker\InvokerInterface|null
     */
    private $invoker;
    ...
    /**
     * @return \AcVendor\Invoker\InvokerInterface
     */
