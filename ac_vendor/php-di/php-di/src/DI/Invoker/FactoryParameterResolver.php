...
class FactoryParameterResolver implements ParameterResolver
{
    ...
    public function getParameters(
        ...
        foreach ($parameters as $index => $parameter) {
            ...
            if ($parameterClass->name === 'AcVendor\Interop\Container\ContainerInterface'
                || $parameterClass->name === 'AcVendor\Psr\Container\ContainerInterface') {
                $resolvedParameters[$index] = $this->container;
            } elseif ($parameterClass->name === 'AcVendor\DI\Factory\RequestedEntry') {
